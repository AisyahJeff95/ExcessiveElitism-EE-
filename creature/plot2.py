...
def trajectory(pop_radius,genomes):
  ...
  # x2 = patches.Rectangle((-100,12.5), width=200, height=3.5, angle=0.0, color='wheat', fill='wheat')#valley1
  # x3 = patches.Rectangle((-100,37.5), width=200, height=3.5, angle=0.0, color='wheat', fill='wheat')#valley2
